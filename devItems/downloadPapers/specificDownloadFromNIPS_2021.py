...
strUrlName = 'url_{}_{}.txt'.format(strConferenceName, 2021)
driver.get("https://papers.nips.cc/paper/2021")

divSection = driver.find_elements(By.XPATH, "//div[@class='container-fluid']")
lstStrs = []
    ...
    for j in range(0, len(divSection)):
        ...
        for i in range(0, len(elements)):
            try:
                ...
                eleAuthor = ele.find_element(By.XPATH, ".//i")
