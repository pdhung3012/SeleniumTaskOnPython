...
fopSearchResultFolder=fopOutputSearch+eventid+'/'
...
fpOutputCsvSearchResult=fopSearchResultFolder+'result.csv'
fpOutputExcelSearchResult=fopSearchResultFolder+'result.xlsx'
fpOutputLogMessage=fopSearchResultFolder+'logMessage.txt'
lstKeyWords=['parallel','parallel programming']
