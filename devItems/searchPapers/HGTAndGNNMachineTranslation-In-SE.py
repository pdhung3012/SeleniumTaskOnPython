...
fonSearchName='GNNAndMT-In-SE'
lstKeyWords=[('machine translation',1),('translation',0.5),('graph',0.5),('gnn',1),('graph neural network',1),('heterogeneous',1)]
