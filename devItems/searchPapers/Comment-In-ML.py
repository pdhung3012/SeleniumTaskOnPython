...
fonSearchName='Comment-In-ML'
lstKeyWords=[('comment',1),('natural',0.2),('commit',1),('pseudo',0.2),('text',0.2),('nlp',0.2),('code',0.5)]
...
lstKeyWords=[('comment',1),('commit',1),('pseudocode',1),('code',1)]
